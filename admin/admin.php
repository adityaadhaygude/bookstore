        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="options my-3">
                    ...
                    <a href="edit.php"><button class="btn btn-success">Edit book</button></a>
                ...
                <?php  
                    ...
                    echo '<div class="card"><img class="card-img-top" src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" class="img-thumnail" /><br><br>Title : '.$title.'<br>Author : '.$author.'<br>Price : '.$price.'<br>Quantity : '.$avail.'<br></div>';  
