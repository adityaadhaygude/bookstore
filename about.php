...
<html lang="en">
  ...
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="#" onclick="message()">Contact</a>
    </li>
  </ul>
</nav>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="justify-content-center " style="margin-top: 1%;">
       <div class="card">
         <p style="font-size: 16px;">This site provides a medium to buy or sell your old books,new books.
          <br>Thank you!</p>
       </div><br>       
       
       <div class="card">
         <p style="font-size: 16px;">Special thanks to bootstrap open source files<br></p>
       </div>
       <br>
       <div class="card">
         <p style="font-size: 16px;">The site is based on HTML, CSS, JS, PHP & DATABASE<br></p>
       </div>
      </div>
    </main>
  </div>
